...
# Дашборд для мониторинга автопарка в реальном времени

## Обзор проекта
Динамический операционный BI-дашборд для диспетчеров автопарка, автоматизирующий управление международными перевозками (ЕС–СНГ) по принципу отклонений. Система фильтрует штатные операции и выводит на экран только критические ситуации, требующие немедленного вмешательства логистов.
